...
for i = 1:total_slot_num
    % draw rectangle
    rectangle('Position',[slot_xy_flag(i,1) - slot_depth/2, ...
        slot_xy_flag(i,2) - slot_width/2, slot_depth, slot_width]);
    hold on;
    if (slot_xy_flag(i,4) == 1)
        rectangle('Position',[slot_xy_flag(i,1) - car_len/2, ...
            slot_xy_flag(i,2) - car_wid/2, car_len, car_wid], ...
            'FaceColor', 'b');
        hold on;
    end
end
